...
class Game : AppCompatActivity() {
    ...
    inner class Holder(binding: ActivityThirdBinding, bool: Boolean) {
        ...
        init {
            ...
            if(bool) {
                ...
                Toast.makeText(this@Game, textToast, Toast.LENGTH_LONG).show()
            }
        }
        ...
        fun check(): GAN.Answer{
            ...
            state = when(answer){
                ...
                GAN.Answer.TOOSMALL-> {
                    ...
                    Toast.makeText(this@Game, textToast, Toast.LENGTH_SHORT).show()
                    R.drawable.ic_wrong
                }
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle) {
        ...
        binding.tvGAN.text= savedInstanceState.getString("image")?.toUri().toString()
