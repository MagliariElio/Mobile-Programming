...
import it.mem.guessTheNumber.databinding.ActivityThirdBinding
...
class ThirdActivity : AppCompatActivity() {
    ...
    inner class Holder(binding: ActivityThirdBinding, bool: Boolean) {
        ...
        init {
            ...
            if(bool) {
                ...
                Toast.makeText(this@ThirdActivity, textToast, Toast.LENGTH_LONG).show()
            }
        }
        ...
        fun check(): GAN.Answer{
            ...
            state = when(answer){
                ...
                GAN.Answer.TOOSMALL -> {
                    ...
                    Toast.makeText(this@ThirdActivity, textToast, Toast.LENGTH_SHORT).show()
                    R.drawable.ic_wrong
                }
            ...
            mybinding.ivState.tag=("android.resource://it.mem.guessTheNumber/$state")
            return answer
        }
                        ...
                        when (check()) {
                            ...
                            GAN.Answer.YOUWIN, GAN.Answer.YOULOOSE -> {
                                mybinding.tvAttempts.text =
                                    (mybinding.tvAttempts.text.toString().toInt() + 1).toString()
                                disableButtons()
                                textToast = getText(R.string.tap_face_restart_toast) as String
                                Toast.makeText(this@ThirdActivity, textToast, Toast.LENGTH_LONG)
                                    .show()
                            }
                        }
                        mybinding.tvGAN.text = ""
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle) {
        ...
        binding.ivState.tag=(savedInstanceState.getString("image"))
