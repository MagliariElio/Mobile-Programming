...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        private var SPLASHSCREEN: Long = 6000
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.ivGreet.animation = titleAnimation
        binding.ivBubble1.animation = titleAnimation
        binding.ivBubble2.animation = titleAnimation
        binding.ivBubble3.animation = titleAnimation
