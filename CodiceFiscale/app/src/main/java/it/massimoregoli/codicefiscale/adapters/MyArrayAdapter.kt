package it.massimoregoli.codicefiscale.adapters
...
import it.massimoregoli.codicefiscale.viewmodels.CountryModel
import java.util.*

class MyArrayAdapter(context: Context, private val resource: Int, placesList: List<CountryModel>) :
