...
class MainActivity : AppCompatActivity() {
    ...
    private fun readFile() {
        ...
        binding.etCountryName.hint = getString(R.string.wait_please)
            ...
            reader.useLines { lines ->
                ...
                launch(Dispatchers.Default) {
                    ...
                    launch(Dispatchers.Main) {
                        ...
                        binding.etCountryName.hint = getString(R.string.birth_country)
                    }
                }
            }
            if(binding.etCountryName.text.toString()!=""){
                findSingleCountry(binding.etCountryName.text.toString())
            }
        }
    }
    ...
    private fun setViewModel() {
        val fiscalCodeObserver = Observer<String> { cf ->
            ...
            binding.tvFiscalCode.isVisible=(cf!="XXXXXX99X99X999R")
        }
